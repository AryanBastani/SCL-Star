    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            if (line.hasOption(SRC_DIR)) {
                ...
                file_path = experimentProperties.getProp("fsm_dir");
            }
...
//        initial the experiment properties
            ...
            try {
                target = Utils.getInstance().loadMealyMachineFromDot(f);
            } catch (Exception e) {
                throw new RuntimeException(e);
            }

            System.out.println("FSM from : " + file_path);
            System.out.println("#States: " + target.size());
...
//                    new WpMethodEQOracle<>(testOracleForEQoracle, 2);
        ...
        System.out.println(mq_sym.getStatisticalData().toString());
        System.out.println(eq_rst.getStatisticalData().toString());
        System.out.println(eq_sym.getStatisticalData().toString());
//        // statistics array
...
//        data[csvProperties.getIndex(LIP + COMPONENTS)] = String.valueOf(Mealy_LIP.getSigmaFamily().size());
    ...
    public static void learnProductMealy(CompactMealy mealyss, Alphabet<String> alphabet, String eq_method, boolean test_mode) {
        ...
        // learning statistics
        System.out.println("___  L* algorithm  ___");
